...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        // Dron ID: 2
        Dron dronTestowyCiezki = new Dron((byte)2,
                "CiezkiDron",
                20d, 10d, 50d);
        ...
        // Dron ID: 3
        RacingDrone dronWyscigowy1 = new RacingDrone((byte)3,
                "DronWyscigowy1",
                10d, 50d, 80d,
                "RampolisRT", 7);
        ...
        // Dron ID: 4
        RacingDrone dronWyscigowy2 = new RacingDrone((byte)4,
                "DronWyscigowy2",
                12d, 58d, 80d,
                "Verne Energy", 5);
        ...
        // Dron ID: 5
        RacingDrone dronWyscigowy3 = new RacingDrone((byte)5,
                "DronWyscigowy3",
                11d, 48d, 80d,
                "Corigis Power", 4);
        ...
        // VAMPIRE DRONES
        // Dron ID: 6
        VampireDrone vamp1 = new VampireDrone((byte)6,
                15d, 30d, 50d);
        ...
        // CHRISTMAS DRONES
        // Dron ID: 7
        ChristmasDrone christmasDrone1 = new ChristmasDrone((byte)7,
                "Delivery 1",
                teddyBear);
        ...
        // Dron ID: 8
        ChristmasDrone christmasDrone2 = new ChristmasDrone((byte)8,
                "Delivery 2",
                toyCar);
        ...
        // Dron ID: 9
        ChristmasDrone christmasDrone3 = new ChristmasDrone((byte)9,
                "Delivery 3",
                gardenToyHouse);
